...
basic_schema_test() ->
    ...
    cuttlefish_unit:assert_config(Config, "riak_kv.consistency_paranoia", medium),
...
override_non_multi_backend_schema_test() ->
    ...
    Conf = [
        ...
        {["strong_consistency", "paranoia"], low},
    ...
    cuttlefish_unit:assert_config(Config, "riak_kv.consistency_paranoia", low),
