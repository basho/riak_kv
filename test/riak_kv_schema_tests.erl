...
basic_schema_test() ->
    ...
    cuttlefish_unit:assert_config(Config, "riak_kv.consistency_trust", medium),
...
override_non_multi_backend_schema_test() ->
    ...
    cuttlefish_unit:assert_config(Config, "riak_kv.consistency_trust", high),
