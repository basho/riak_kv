...
legacy_stat_map() ->
    [%% vnode stats: gets & puts
     ...
     %% datatype stats: ranges
     {object_range_merge, {{riak_kv, object, range, merge}, one}, spiral},
     {object_range_merge_total, {{riak_kv, object, range, merge}, count}, spiral},
     {object_range_merge_time_mean, {{riak_kv, object, range, merge, time}, arithmetic_mean}, histogram},
     {object_range_merge_time_median, {{riak_kv, object, range, merge, time}, median}, histogram},
     {object_range_merge_time_95, {{riak_kv, object, range, merge, time}, 95}, histogram_percentile},
     {object_range_merge_time_99, {{riak_kv, object, range, merge, time}, 99}, histogram_percentile},
     {object_range_merge_time_100, {{riak_kv, object, range, merge, time}, max}, histogram},
     {vnode_range_update, {{riak_kv, vnode, range, update}, one}, spiral},
     {vnode_range_update_total, {{riak_kv, vnode, range, update}, count}, spiral},
     {vnode_range_update_time_mean, {{riak_kv, vnode, range, update, time}, arithmetic_mean}, histogram},
     {vnode_range_update_time_median, {{riak_kv, vnode, range, update, time}, median}, histogram},
     {vnode_range_update_time_95, {{riak_kv, vnode, range, update, time}, 95}, histogram_percentile},
     {vnode_range_update_time_99, {{riak_kv, vnode, range, update, time}, 99}, histogram_percentile},
     {vnode_range_update_time_100, {{riak_kv, vnode, range, update, time}, max}, histogram},
     ...
     %% node stats: gets: ranges
     {node_gets_range, {{riak_kv,node,gets,range}, one}, spiral},
     {node_gets_range_total, {{riak_kv,node,gets,range}, count}, spiral},
     {node_get_fsm_range_siblings_mean, {{riak_kv,node,gets,range,siblings}, arithmetic_mean}, histogram},
     {node_get_fsm_range_siblings_median, {{riak_kv,node,gets,range,siblings}, median}, histogram},
     {node_get_fsm_range_siblings_95, {{riak_kv,node,gets,range,siblings}, 95}, histogram_percentile},
     {node_get_fsm_range_siblings_99, {{riak_kv,node,gets,range,siblings}, 99}, histogram_percentile},
     {node_get_fsm_range_siblings_100, {{riak_kv,node,gets,range,siblings}, max}, histogram},
     {node_get_fsm_range_objsize_mean, {{riak_kv,node,gets,range,objsize}, arithmetic_mean}, histogram},
     {node_get_fsm_range_objsize_median, {{riak_kv,node,gets,range,objsize}, median}, histogram},
     {node_get_fsm_range_objsize_95, {{riak_kv,node,gets,range,objsize}, 95}, histogram_percentile},
     {node_get_fsm_range_objsize_99, {{riak_kv,node,gets,range,objsize}, 99}, histogram_percentile},
     {node_get_fsm_range_objsize_100, {{riak_kv,node,gets,range,objsize}, max}, histogram},
     {node_get_fsm_range_time_mean, {{riak_kv,node,gets,range,time}, arithmetic_mean}, histogram},
     {node_get_fsm_range_time_median, {{riak_kv,node,gets,range,time}, median}, histogram},
     {node_get_fsm_range_time_95, {{riak_kv,node,gets,range,time}, 95}, histogram_percentile},
     {node_get_fsm_range_time_99, {{riak_kv,node,gets,range,time}, 99}, histogram_percentile},
     {node_get_fsm_range_time_100, {{riak_kv,node,gets,range,time}, max}, histogram},
     ...
     %% node stats: puts: ranges
     {node_puts_range, {{riak_kv,node, puts, range}, one}, spiral},
     {node_puts_range_total, {{riak_kv,node, puts, range}, count}, spiral},
     {node_put_fsm_range_time_mean, {{riak_kv,node, puts, range, time}, arithmetic_mean}, histogram},
     {node_put_fsm_range_time_median, {{riak_kv,node, puts, range, time}, median}, histogram},
     {node_put_fsm_range_time_95,  {{riak_kv,node, puts, range, time}, 95}, histogram_percentile},
     {node_put_fsm_range_time_99,  {{riak_kv,node, puts, range, time}, 99}, histogram_percentile},
     {node_put_fsm_range_time_100, {{riak_kv,node, puts, range, time}, max}, histogram},
     ...
     {read_repairs_range, {{riak_kv,node,gets,range,read_repairs}, one}, spiral},
     {read_repairs_range_total, {{riak_kv,node,gets,range,read_repairs}, count}, spiral},
