...
legacy_stat_map() ->
    [{vnode_gets, {{riak_kv, vnode, gets}, one}, spiral},
     ...
     {vnode_counter_merge, {{riak_kv, vnode, counter, merge}, one}, spiral},
     {vnode_counter_merge_total, {{riak_kv, vnode, counter, merge}, count}, spiral},
     {vnode_counter_merge_time_mean, {{riak_kv, vnode, counter, merge, time}, arithmetic_mean}, histogram},
     {vnode_counter_merge_time_median, {{riak_kv, vnode, counter, merge, time}, median}, histogram},
     {vnode_counter_merge_time_95, {{riak_kv, vnode, counter, merge, time}, 95}, histogram_percentile},
     {vnode_counter_merge_time_99, {{riak_kv, vnode, counter, merge, time}, 99}, histogram_percentile},
     {vnode_counter_merge_time_100, {{riak_kv, vnode, counter, merge, time}, max}, histogram},
     ...
     {vnode_set_merge, {{riak_kv, vnode, set, merge}, one}, spiral},
     {vnode_set_merge_total, {{riak_kv, vnode, set, merge}, count}, spiral},
     {vnode_set_merge_time_mean, {{riak_kv, vnode, set, merge, time}, arithmetic_mean}, histogram},
     {vnode_set_merge_time_median, {{riak_kv, vnode, set, merge, time}, median}, histogram},
     {vnode_set_merge_time_95, {{riak_kv, vnode, set, merge, time}, 95}, histogram_percentile},
     {vnode_set_merge_time_99, {{riak_kv, vnode, set, merge, time}, 99}, histogram_percentile},
     {vnode_set_merge_time_100, {{riak_kv, vnode, set, merge, time}, max}, histogram},
     ...
     {vnode_map_merge, {{riak_kv, vnode, map, merge}, one}, spiral},
     {vnode_map_merge_total, {{riak_kv, vnode, map, merge}, count}, spiral},
     {vnode_map_merge_time_mean, {{riak_kv, vnode, map, merge, time}, arithmetic_mean}, histogram},
     {vnode_map_merge_time_median, {{riak_kv, vnode, map, merge, time}, median}, histogram},
     {vnode_map_merge_time_95, {{riak_kv, vnode, map, merge, time}, 95}, histogram_percentile},
     {vnode_map_merge_time_99, {{riak_kv, vnode, map, merge, time}, 99}, histogram_percentile},
     {vnode_map_merge_time_100, {{riak_kv, vnode, map, merge, time}, max}, histogram},
