...
start(Partition, Config) ->
    ...
    JTO = app_helper:get_prop_or_env(journal_deletetimeout, Config, leveled),
    JTJ = app_helper:get_prop_or_env(journal_deletejitter, Config, leveled),
        ...
        {ok, DataDir} ->
            ...
            StartOpts =
                [{root_path, DataDir},
                    ...
                    {journal_initial_deletetimeout, {JTO, JTJ}}
                ],
