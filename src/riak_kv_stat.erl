...
stats() ->
    ...
    [{[vnode, gets], spiral, [], [{one  , vnode_gets},
     ...
     {[vnode, gset, update], spiral, [], [{one  , vnode_gset_update},
                                          {count, vnode_gset_update_total}]},
     {[vnode, gset, update, time], histogram, [], [{mean  , vnode_gset_update_time_mean},
                                                   {median, vnode_gset_update_time_median},
                                                   {95    , vnode_gset_update_time_95},
                                                   {99    , vnode_gset_update_time_99},
                                                   {max   , vnode_gset_update_time_100}]}, 
