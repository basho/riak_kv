...
stats() ->
    ...
    [{[vnode, gets], spiral, [], [{one  , vnode_gets},
     ...
     {[vnode, gets, time], histogram, [], [{mean  , node_get_fsm_time_mean},
     ...
     {[vnode, puts, time], histogram, [], [{mean  , node_put_fsm_time_mean},
     ...
     {[object, map, merge, time], histogram, [], [{one  , object_merge},
                                                  {count, object_merge_total}]},
